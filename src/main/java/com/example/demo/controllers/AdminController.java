...
public String orderHandler(@ModelAttribute Orders order, RedirectAttributes redirectAttributes) {
    ...
    // ✅ Add flash attributes for toast
    redirectAttributes.addFlashAttribute("toastMessage", "Order placed successfully!");
...
public String back(Model model) {
    List<Orders> orders = this.orderServices.getOrdersForUser(user);
    model.addAttribute("orders", orders);
    model.addAttribute("name", user.getUname());  // Add this line if needed
    return "BuyProduct";
}
